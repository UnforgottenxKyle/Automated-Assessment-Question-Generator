                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">TRUE OR FALSE</span>
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Mutliple Choice</span>
                                <span class="info-box-number text-right">
                                <?php 
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            <span class="info-box-icon bg-gradient-light elevation-1"><i class="fas fa-question"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">ENUMERATION</span>
                                <span class="info-box-number text-right">
                                <?php 
                                    $question = $conn->query("SELECT * FROM question_list where question_paper_id = '{$id}' and `type` = 4 ")->num_rows;
                                    echo format_num($question);
                                ?>
                                <?php ?>
                                </span>
                                <span class="w-100 text-center"><a href="./?page=question_papers/view_question_paper&id=<?= isset($id) ? $id : "" ?>&type=4" data="">View List</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            <span class="info-box-icon bg-gradient-primary elevation-1"><i class="fas fa-question"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">Identification</span>
                                <span class="info-box-number text-right">
                                <?php 
                                    $question = $conn->query("SELECT * FROM question_list where question_paper_id = '{$id}' and `type` = 5 ")->num_rows;
                                    echo format_num($question);
                                ?>
                                <?php ?>
                                </span>
                                <span class="w-100 text-center"><a href="./?page=question_papers/view_question_paper&id=<?= isset($id) ? $id : "" ?>&type=5" data="">View List</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                <?php if(isset($_GET['type'])): ?>
                    <?php $type_arr = ['','True or False','Multiple Choice','Essay','Enumeration','Identification'] ?>
