        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <option value="1" <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>True or False</option>
                    <option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Multiple Choice</option>
                    <option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Essay</option>
                    <option value="4" <?php echo isset($type) && $type == 4 ? 'selected' : '' ?>>Enumeration</option>
                    <option value="5" <?php echo isset($type) && $type == 5 ? 'selected' : '' ?>>Identification</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
