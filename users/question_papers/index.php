...
<?php endif;?>
<div class="card card-outline rounded-0 card-success">
	<div class="card-header">
		<h3 class="card-title">List of Question Papers</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-success"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
