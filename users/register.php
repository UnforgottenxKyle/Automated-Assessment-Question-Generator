...
<html lang="en" class="">
 ...
 <script>
  function displayErrorMessage() {
    ...
    if (errorParam === 'email_taken') {
      alert_toast("Email already registered.", 'error');
    }
  }
...
<body class="">
    ...
    <div id="main" class="h-100 d-flex flex-row align-item-center">
        ...
        <div class="col-7 h-100 bg-gradient-light">
            <div class="d-flex h-100 flex-column align-items-center justify-content-center w-100">
                <div class="card card-outline card-success my-2 rounded-0 shadow w-75">
                    ...
                    <div class="card-body">
                        <form id="uregister-frm" action="" method="post">
                            ...
                            <div class="col-4">
                                <button type="submit" id="submitButton" class="btn btn-success btn-block btn-flat btn-sm">Register</button>
                            </div>
                                <div class="btn btn-success btn-block btn-flat btn-sm col-12 text-center mx-auto d-flex justify-content-center align-items-center" style='margin-top:10px; max-width: 40%;'>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        ?>
                                        <a href="<?php echo filter_var($authUrl); ?>" style='color:white !important;'class="login-btn"><strong>Sign up with Google</strong></a>
                                    </div>
                                </div>
    ...
    document.getElementById('dob').addEventListener('change', function () {
        ...
        if (age < 18) {
            ...
            // Display a message
            document.getElementById('ageValidationMessage').innerText = 'You must be 18 or older to register.';
        } else {
            // Enable the submit button
            document.getElementById('submitButton').disabled = false;

            // Clear the message
            document.getElementById('ageValidationMessage').innerText = '';
        }
    });
    ...
    function validatePassword(password) {
        // Check if the password has at least 8 characters and includes at least one capital letter
        var regex = /^(?=.*[A-Z]).{8,}$/;
    ...
    $('#uregister-frm').submit(function(e){
        ...
        if (!validatePassword($('#password').val())) {
                el.text('Password must have at least 8 characters and include at least one capital letter.');
                _this.prepend(el);
                el.show('slow');
                $("html, body").animate({ scrollTop: _this.closest('.card').offset().top }, "fast");
                return false;
