<div class="contact py-3">
	<div class="card card-outline card-success shadow rounded-0">
					...
					<div class="row justify-content-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="company_name" class="control-label">Group Name</label>
                            ...
                            <div class="form-group">
                                <label for="company_description" class="control-label">Group Short Description</label>
        ...
        <div class="card-footer py-1 text-right">
            <button class="btn btn-success btn-flat" type="submit" form="contact-form"><i class="fa fa-save"></i> Save Contact Information</button>
        </div>
	</div>
</div>
<script>
