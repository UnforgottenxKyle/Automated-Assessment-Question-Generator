...
<div class="card card-outline rounded-0 card-primary">
							...
							<div class="form-group">
								...
								<div class="input-group input-sm">
									...
									<div class="input-group-append">
										<button type="button" class="btn btn-default border-top-0 border-left-0 border-right-0 rounded-0 pass_view btn-sm" tabindex="-1">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group d-flex justify-content-center">
							<img src="<?php echo validate_image(isset($avatar)? $avatar : '') ?>" alt=""  referrerpolicy="no-referrer"  id="cimg" class="img-fluid img-thumbnail">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-success" form="update-frm">Update</button>
				</div>
			</div>
		</div>
</div>
